...
class FullyConnectedNetwork(nn.Module):
    def __init__(self, input_dim, output_dim, arch='256-256', orthogonal_init=False, is_LN=0, is_SN=False):
        super().__init__()
...
class TanhGaussianPolicy(nn.Module):
    ...
    def __init__(self, observation_dim, action_dim, arch='256-256',
        ...
        self.base_network = FullyConnectedNetwork(
            observation_dim, 2 * action_dim, arch, orthogonal_init, is_LN=0, is_SN=False
        )
